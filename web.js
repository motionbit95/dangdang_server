...
app.get("/reset/:collection", async (req, res) => {
  const firestore = admin.firestore();
  const collectionRef = firestore.collection(req.params.collection);
  await deleteCollection(collectionRef);

  res.send("delete " + req.params.collection + " collection");
});

app.get("/add-dummy/:collection", async (req, res) => {
  // const firestore = admin.firestore();
  let dummyDatas = [];
  ...
  try {
    await addDummyData(req.params.collection, dummyDatas);

    res.send("add " + req.params.collection + " dummy data");
  } catch (error) {
